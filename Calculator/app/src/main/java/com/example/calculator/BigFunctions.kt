...
object BigFunctions {
     ...
     * @param scale the desired scale of the numericString
     * @return the numericString value
     */
    fun intPower(
    ...
    fun exp(x: BigDecimal, scale: Int): BigDecimal {
        ...
        var numericString = BigDecimal.valueOf(1)

        // Compute and return t^whole using intPower().
        // If whole > Long.MAX_VALUE, then first compute products
        // of e^Long.MAX_VALUE.
        while (xWhole.compareTo(maxLong) >= 0) {
            numericString = numericString.multiply(
        ...
        return numericString.multiply(intPower(t, xWhole.toLong(), scale))
            .setScale(scale, BigDecimal.ROUND_HALF_EVEN)
    }
